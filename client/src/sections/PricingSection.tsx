            ...
            <div className="flex flex-wrap items-center justify-center gap-8 mt-20">
                ...
                appearance={{
                    ...
                    elements:{
                        ...
                        pricingTableButton:
  "bg-pink-500 hover:bg-pink-600 active:bg-pink-700 text-white rounded-xl shadow-lg"
...
//                     >
//                         {plan.mostPopular && (
//                             <p className="absolute px-3 text-sm -top-3.5  left-35 py-1 bg-pink-400 rounded-full ">Most Popular</p>
//                         )}
//                         <p className="font-semibold text-start">{plan.name}</p>
//                         <h1 className="text-3xl font-semibold text-start">${plan.price}<span className="text-gray-500 font-normal text-sm">/{plan.period}</span></h1>
