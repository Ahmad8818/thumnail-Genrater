  ...
  return (
    <div className="relative mx-auto w-full max-w-2xl">
        <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
            {isLoading && (
                <div className="absolute inset-0 flex flex-col item-center justify-center
                gap-4 bg-black/25 ">
            ...
            {/* image Preview */}
            {
                !isLoading && thumbnail?.image_url && (
                    <div className="group relative h-full w-full">
                        ...
                        src={thumbnail.image_url} alt={thumbnail.title} />
                        ...
                        bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
                           ...
                           text-xs font-medium transition bd-white/30 ring-2 ring-white/40
