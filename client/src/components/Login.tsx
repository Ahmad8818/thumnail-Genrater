    ...
    return (
        ...
        <div className="min-h-screen m-5 flex items-center justify-center">
            <form
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white/5 ring-2 ring-white/10
                    focus-within:ring-pink-500/60 h-12 rounded-full
                    overflow-hidden pl-6 gap-2 transition-all ">
