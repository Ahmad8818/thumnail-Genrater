        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                   ...
                   {
                    isLoggedIn ? 
                   <Link to='/my-genration' className="hover:text-pink-500 transition">My Generations</Link>
                   :
                   <Link to='#' className="hover:text-pink-500 transition"> About</Link>


                   }
                   {/* <Link to={isLoggedIn ? '/my-generation': '/login'} className="hover:text-pink-500 transition">My Generations Test</Link> */}
                   ...
                   <Link to='#'
                   onClick={()=>logout()}
                   className="hover:text-pink-500 transition">Logout</Link>
