...
import product8 from './product8.webp'; // hand bag women

import model1 from './model1.png'; // model men
import model2 from './model2.jpg'; // model women
import model3 from './model3.jpg'; // model women
...
import purseVideo from './purse-video.mp4'; // random product women 16:9

import handBagVideo from './handBagVideo.mp4'
export const assets = {
    logo,
    product1,
    product2,
...
export const dummyGenerations = [
    ...
    },
    {
        id: 'gen_3',
        aspectRatio: '9:16',
        productDescription: 'Modern Hand Bag',
        productName: 'Hand Bag',
        targetLength: 8,
        uploadedImages: [product8, model3],
        userId: 'user_2',
        userPrompt: 'Emphasize the comfort and sound quality of the headphones',
        generatedImage: model3,
        generatedVideo: purseVideo,
        isGenerating: false,
        isPublished: true,
        createdAt: '2026-01-18T00:00:00.000Z',
        updatedAt: '2026-02-13T00:50:00.000Z',
    },
    {
        id: 'gen_4',
        aspectRatio: '16:9',
